...
const Footer = () => {
  ...
  <footer class="bg-black opacity-95">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    {/* <img src="https://icons8.com/icon/S0EAaDbYMKLx/mark-view-as-non-hidden" class="h-8 mr-3" alt="FlowBite Logo" /> */}
                    <div class="mt-2 mr-3">
                      <span class="text-orange-500 scale-150 material-icons ">token</span>
                    </div>
                    <span class="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">TalentSync</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-lg font-semibold text-white-900 uppercase dark:text-white">DAO</h2>
                ...
                <div>
                    <h2 class="mb-6 text-lg font-semibold text-white-900 uppercase dark:text-white">Developers</h2>
                    <ul class="text-white-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                        <a href="#" class=" hover:underline">
                          Create
                ...
                <div>
                    <h2 class="mb-6 text-lg font-semibold text-white-900 uppercase dark:text-white">Help Center</h2>
                    <ul class="text-white-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                        <a href="#" class="hover:underline">
                          Discord Server
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">TalentSync™</a>. All Rights Reserved.
            </span>
