  ...
  return (
    <div className="min-h-[calc(70vh)] text-white">
      ...
      <div className="w-full ">
        {gig?.awsImageLink && (
          <Image
            className="rounded-3xl w-full h-[60vh] hideItOut"
      ...
      {showReviews == true ? (
        <div className=" mb-20">
          <div className="flex justify-between items-center">
            ...
            <p
              className="text-md font-bold p-8 text-blue-200 hover:underline cursor-pointer"
              ...
              <>
                <div className="w-full my-2">
                  <div className="h-32 border border-blue-400 text-center flex items-center justify-center">
                    <p className="font-light text-xs text-white p-4">
                      {" "}
                      {review?.comment}
                    </p>
                  </div>
        ...
        <>
          {!isMyGig && (
            <>
              ...
              <div className="flex justify-between w-full ">
                <p className="font-light text-xs text-blue-200 p-4">
                  {" "}
          ...
          <div
            className="p-10 rounded-2xl mb-20"
            style={{
              zIndex: 10000,
          ...
          >
            <p className="font-bold  pt-5 -mt-10 text-blue-400 underline">
              About The Gig
            </p>
            <div className="w-full">
              <p className="text-sm pr-8 py-8">
                {gig?.description?.slice(0, 830)}
              </p>
            </div>
            {!isMyGig && (
              <div className="flex rounded-lg my-2 h-32 border-blue-400 border border-blue-400-blue-400 p-4 text-xs md:text-lg">
            ...
            {!isMyGig && (
              <div className=" flex flex-col pt-10 hideItOut">
                <div className="flex-col space-x-1">
                  ...
                  <div className="flex justify-between -mt-5">
                    ...
                    <div className="flex justify-end items-center">
                      <span
                        className={
                          "font-light text-white border-blue-400-2 px-3 py-1 rounded-md text-sm cursor-pointer p-5 border border-blue-400-blue-400"
                        }
                        onClick={() =>
                          router.push({
                  ...
                  <div className="flex p-4 rounded-lg my-2 h-32 mb-20 border-blue-400 border border-blue-400-blue-400">
